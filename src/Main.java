...
import sercives.impl.UtilisateurServiceImpl;
...
public class Main {
    public static void main(String[] args) {
        ...
        // Ajouter l'utilisateur par défaut au démarrage
        ...
        while (!authenticated) {
            ...
            authenticated = autilisateurService.getUser(inputIdentifiant, inputMotDePasse);
